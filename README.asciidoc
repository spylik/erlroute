image:https://api.travis-ci.org/spylik/erlroute.svg?branch=master[title="Build Status", link="https://travis-ci.org/spylik/erlroute"] image:https://coveralls.io/repos/github/spylik/erlroute/badge.svg?branch=master[title="Test coverage", link="https://coveralls.io/github/spylik/erlroute?branch=master"]

= Erlroute

Erlroute is the simple, message router.

Erlroute do simple work - he just map routine of sending messages to multiple subscriber. It just bring dynamic message multiroute future to standard erlang actor model and do it without amq-protocol overhead.
